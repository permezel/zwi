...
class Table(object):
    ...
    def finally__(self, oth):
        ...
        debug(2, f'{self=} {oth=} {self._name=} {oth._name=}')
...
class Followers(object):
    ...
    @tab.col
    def followerId(self):
        return self._data['followerId']

    @tab.col
    def followeeId(self):
        return self._data['followeeId']
    ...
    @property
    def followerProfile(self):
        return self._data['followerProfile']

    @tab.col
    def wer_publicId(self):
        return self._wer['publicId']

    @tab.col
    def wer_firstName(self):
        return self._wer['firstName']

    @tab.col
    def wer_lastName(self):
        return self._wer['lastName']

    @tab.col
    def wer_male(self):
        return self._wer['male']

    @tab.col
    def wer_imageSrc(self):
        return self._wer['imageSrc']

    @tab.col
    def wer_imageSrcLarge(self):
        return self._wer['imageSrcLarge']

    @tab.col
    def wer_playerType(self):
        return self._wer['playerType']

    @tab.col
    def wer_countryAlpha3(self):
        return self._wer['countryAlpha3']

    @tab.col
    def wer_countryCode(self):
        return self._wer['countryCode']

    @tab.col
    def wer_useMetric(self):
        return self._wer['useMetric']

    @tab.col
    def wer_riding(self):
        return self._wer['riding']

    @property
    def wer_privacy(self):
        return self._wer['privacy']

    @tab.col
    def werp_displayWeight(self):
        return self._werp['displayWeight']

    @tab.col
    def werp_minor(self):
        return self._werp['minor']

    @tab.col
    def werp_privateMessaging(self):
        return self._werp['privateMessaging']

    @tab.col
    def werp_defaultFitnessDataPrivacy(self):
        return self._werp['defaultFitnessDataPrivacy']

    @tab.col
    def werp_suppressFollowerNotification(self):
        return self._werp['suppressFollowerNotification']

    @tab.col
    def werp_displayAge(self):
        return self._werp['displayAge']

    @tab.col
    def werp_defaultActivityPrivacy(self):
        return self._werp['defaultActivityPrivacy']

    @property
    def wer_socialFacts(self):
        return self._wer['socialFacts']

    @tab.col
    def wers_followersCount(self):
        return self._wers['followersCount']

    @tab.col
    def wers_followeesCount(self):
        return self._wers['followeesCount']

    @tab.col
    def wers_followeesInCommonWithLoggedInPlayer(self):
        return self._wers['followeesInCommonWithLoggedInPlayer']

    @tab.col
    def wers_followerStatusOfLoggedInPlayer(self):
        return self._wers['followerStatusOfLoggedInPlayer']

    @tab.col
    def wers_followeeStatusOfLoggedInPlayer(self):
        return self._wers['followeeStatusOfLoggedInPlayer']

    @tab.col
    def wers_isFavoriteOfLoggedInPlayer(self):
        return self._wers['isFavoriteOfLoggedInPlayer']

    @tab.col
    def wer_worldId(self):
        return self._wer['worldId']

    @tab.col
    def wer_enrolledZwiftAcademy(self):
        return self._wer['enrolledZwiftAcademy']

    @tab.col
    def wer_playerTypeId(self):
        return self._wer['playerTypeId']

    @tab.col
    def wer_playerSubTypeId(self):
        return self._wer['playerSubTypeId']

    @tab.col
    def wer_currentActivityId(self):
        return self._wer['currentActivityId']

    @tab.col
    def wer_likelyInGame(self):
        return self._wer['likelyInGame']

    @property
    def followeeProfile(self):
        return self._data['followeeProfile']
    ...
    @classmethod
    def insert_template(cls, obj, db, xtra_col='', xtra_val=''):
    ...
    def db_colmax(cls, db):
        ...
        for c in cls.tab._name:
            try:
                ...
                # print(f'Error: {e}')
                raise SystemExit('You may have to run the `reset` command.')
